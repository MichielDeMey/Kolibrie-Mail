...
{
    public sealed class UidlPop3Response : Pop3Response
    {
        private readonly bool _isSingle;

        public UidlPop3Response(bool isSingle)
        {
            _isSingle = isSingle;
            Uids = new Dictionary<int, string>();
        }

        public IDictionary<int, string> Uids { get; private set; }
