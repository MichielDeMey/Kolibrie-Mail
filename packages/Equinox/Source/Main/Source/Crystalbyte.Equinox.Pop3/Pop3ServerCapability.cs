...
{
    public sealed class Pop3ServerCapability
    {
        private readonly IDictionary<string, string> _items = new Dictionary<string, string>();

        public bool IsTlsSupported
        {
            get { return _items.ContainsKey("STLS"); }
        }

        public bool IsTopSupported
        {
            get { return _items.ContainsKey("TOP"); }
        }

        public bool IsUserSupported
        {
            get { return _items.ContainsKey("USER"); }
        }
