...
{
    [DebuggerDisplay("MediaType = {MediaType}, SizeEncoded = {SizeEncoded}")]
    public class ViewInfo : IFetchable
    {
        public ViewInfo()
        {
        ...
        public Size? SizeEncoded { get; internal set; }
        public int TextLinesEncoded { get; internal set; }
