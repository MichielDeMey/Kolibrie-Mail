...
{
    public sealed class StoreImapResponse : ImapResponse
    {
        private readonly List<MessageState> _items;

        public StoreImapResponse()
        {
            _items = new List<MessageState>();
        }

        public IEnumerable<MessageState> MessageStateChanges
        {
            get { return _items; }
        }
