...
namespace Crystalbyte.Equinox.Imap
{
    public sealed class SequenceSet
    {
        ...
        public static SequenceSet CreateUidSet(int from, int to)
        {
            var set = CreateSet(from, to);
            set.IsUid = true;
            return set;
        }

        public static SequenceSet CreateUidSet(IEnumerable<int> values)
        {
            var set = CreateSet(values);
            set.IsUid = true;
            return set;
        }

        public static SequenceSet CreateSet(int single)
        {
            return CreateSet(single, single);
        }

        public static SequenceSet CreateUidSet(int single)
        {
            return CreateUidSet(single, single);
        }
