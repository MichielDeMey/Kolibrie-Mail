...
{
    public sealed class SmtpResponseReader
    {
        ...
        public bool IsLast
        {
            get { return CurrentLine.Substring(3, 1) == " "; }
        }
        ...
        {
            get { return Int32.Parse(CurrentLine.Substring(0, 3)); }
        }
        ...
        public bool IsKnownCapability
        {
            get
            {
                ...
                var upper = CurrentLine.ToUpper();
                return upper.Contains("AUTH") || upper.Contains("SIZE") || upper.Contains("STARTTLS") || upper.Contains("8BITMIME") || upper.Contains("BINARYMIME") || upper.Contains("DSN");
            }
        }

        public int ReadNextLine()
        {
            CurrentLine = WaitFor<string>.Run(_timeout, _client.ReceiveLine);
